...
struct UniformsList
{
    ...
    template <typename T>
    void AddUniform(const std::string &name, const T &initialValue)
    {
    ...
    template <typename T>
    T &UniformValue(const std::string &name)
    {
