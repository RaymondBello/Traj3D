...
std::vector<HelloImGui::DockableWindow> CreateDockableWindows(AppState &appState)
{
    ...
    featuresDemoWindow.GuiFunction = [&]
    { GuiWindowDemoFeatures(appState); };
    ...
    dearImGuiDemoWindow.GuiFunction = []
