...
def load_fonts():  # This is called by runnerParams.callbacks.LoadAdditionalFonts
    ...
    TITLE_FONT = hello_imgui.load_font_ttf("fonts/SF-Pro.ttf", 25.0)
...
def show_menu_gui(runner_params: hello_imgui.RunnerParams):
    ...
    # print([i for i in hello_imgui.__dir__() if "app" in str(i)])
    # hello_imgui.show_view_menu(runner_params)
...
def main():
    ...
    print(f"[INFO] loaded asset folder: {asset_folder}")
    hello_imgui.set_assets_folder(asset_folder)
    ...
    runner_params.imgui_window_params.menu_app_title = "Docking Menu demo"
    ...
    runner_params.ini_filename = "PleaseFindMeFile.ini"
    # end::app_settings[]
